		...
		{{/if}}
			<form class="comment-edit-form" style="display: block;" id="comment-edit-form-{{$id}}" action="item" method="post" onsubmit="post_comment({{$id}}); return false;">
				...
				<div class="comment-edit-submit-wrapper" id="comment-edit-submit-wrapper-{{$id}}" style="display: none;" >
					<div class="btn-group" id="jot-comment-mainbuttons">
					{{if $preview}}
					<span onclick="preview_comment({{$id}});" id="comment-edit-preview-link-{{$id}}" class="btn btn-primary"><i class="icon-eye-open" title="{{$preview}}"></i></span>
					{{/if}}
				
					<input type="submit" onclick="post_comment({{$id}}); return false;" id="comment-edit-submit-{{$id}}" class="btn btn-primary" name="submit" value="{{$submit}}" />
					</div>
				</div>
				{{if $preview}}
