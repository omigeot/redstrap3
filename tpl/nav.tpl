...
<nav class="navbar navbar-inverse" role="navigation">
	...
	{{if $userinfo}}
	      <li id="nav-user-linkmenu" class="nav-menu-icon2 dropdown" ><a href="#" class="dropdown-toggle" data-toggle="dropdown" rel="#nav-user-menu" title="{{$userinfo.name}}"><img src="{{$userinfo.icon}}" alt="{{$userinfo.name}}"><span class="nav-dropdown-indicator">&#x25BC;</span></a>
		{{if $localuser}}
